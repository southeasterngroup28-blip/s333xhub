...
export type Message = {
  ...
  sender: { display_name: string; status: string | null; avatar_path: string | null; avatar_focus: number | null } | null;
};
...
const MESSAGE_COLUMNS =
  'id, channel_id, sender_id, body, kind, media_path, media_url, duration_seconds, created_at, deleted_at, sender:profiles(display_name, status, avatar_path, avatar_focus)';
